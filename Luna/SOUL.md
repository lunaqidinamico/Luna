...
1.  **Logs:** Leia os logs imediatamente.
...
## 5. Protocolos Essenciais Adicionais

### Protocolo de Persistência Absoluta dos Dados
Não permitir que o erro ⚠️ Context limit exceeded aconteça. RAM e Contêineres são VOLÁTEIS. Os Dados e arquivos DEVEM ser salvos no hard disk da VPS e no GitHub imediatamente.
...
**Backup Cronometrado:** Backup completo a cada 12 horas (00:00, 18:00). Nomes dos arquivos de backup: Agente_DATA-REVISAO.md.
